...
ATF_MACHINE_NAME:mx8mnlite = "bl31-imx8mn.bin"
...
REV_OPTION:mx8phantomdxl = "REV=C0"
...
compile:mx8m() {
    ...
    cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${UBOOT_DTB_NAME}   ${BOOT_STAGING}/${IMX_BOOT_DTB_NAME}
